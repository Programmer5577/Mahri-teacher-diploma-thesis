...
function Header() {
  ...
  const handleHistoryClick = () => {
    navigate("/result"); // Перенаправление на страницу результатов
  };

  return (
    <header className="header">
      <div className="user-info">
        <span className="username user-info_blocks">Talyp</span>
        <div className="history user-info_blocks" onClick={handleHistoryClick}>
          <svg
            alt="history icon"
            id="userHistory"
            height="100%"
        ...
        <div className="avatar user-info_blocks">
